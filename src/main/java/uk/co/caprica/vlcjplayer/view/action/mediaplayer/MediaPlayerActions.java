...
public final class MediaPlayerActions {
  ...
  //---------------------NUEVO----------------------
    public PlayAction getPlayBackPlayAction() {
    	return (PlayAction) this.playbackPlayAction;
    } //Esto lo añado para poder notificar al cliente de que se ha dado al play. Necesito acceder a esa PlayAction para ello
  //---------------------/NUEVO----------------------
